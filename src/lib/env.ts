...
const envSchema = z.object({
  ...
  CERT_TESTER_BASE_PRICE: z.coerce.number().positive().default(85),
...
export const env = envSchema.parse({
  ...
  CERT_TESTER_BASE_PRICE: process.env.CERT_TESTER_BASE_PRICE ?? process.env.DEVELOPER_TESTER_BASE_PRICE,
